  ...
  <div class="card card-flush shadow-sm h-100 border-0 mobile-chart-card">
    <div class="card-header pt-6 border-0">
      <h3 class="card-title align-items-start flex-column">
        <span class="card-label fw-bold text-gray-800 fs-5">Produk Paling Banyak Diretur</span>
        <span class="text-muted mt-1 fw-semibold fs-8">Jumlah barang yang dikembalikan (Pcs)</span>
      </h3>
    </div>
...
const renderChart = () => {
  const element = document.getElementById('mobile_return_product_chart')
